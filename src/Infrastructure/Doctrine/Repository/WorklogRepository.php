...
use App\Domain\Core\Entity\Worklog;
 ...
 */
class WorklogRepository extends ServiceEntityRepository implements WorklogRepositoryInterface
{
    ...
    public function add(Worklog $entity, bool $flush = false): void
    {
