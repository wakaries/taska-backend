...
#[ORM\Entity(repositoryClass: TaskRepositoryInterface::class)]
class Task
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\ManyToOne(inversedBy: 'tasks', targetEntity: Epic::class)]
    #[ORM\JoinColumn(nullable: false)]
    private ?Epic $epic = null;

    #[ORM\ManyToOne(inversedBy: 'tasks', targetEntity: Release::class)]
